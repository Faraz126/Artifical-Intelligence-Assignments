...
class EightPuzzleSearchProblem(search.SearchProblem):
    ...
    def getCostOfActions(self, actions):
        ...
        """
        return len(actions) #since each actions costs 1
    ...
    def getHeuristic(self,state):
        ...
        >>> EightPuzzleSearchProblem(EightPuzzleState([1, 0, 2, 3, 4, 5, 6, 7, 8])).getHeuristic(EightPuzzleState([1, 0, 2, 3, 4, 5, 6, 7, 8]))
        0
        >>> EightPuzzleSearchProblem(EightPuzzleState([1, 0, 2, 3, 4, 5, 6, 7, 8])).getHeuristic(EightPuzzleState([1, 0, 4, 5, 6, 1, 2, 3, 8]))
        6
        """
        current = 0
        cost = 0
